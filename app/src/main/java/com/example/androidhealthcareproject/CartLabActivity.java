...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(CartLabActivity.this);
        String url = "http://192.168.101.57:9080/api/v1/user/cart/get";



        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url+ "?username=" + username+ "&otype=" + "xét nghiệm", null,
